...
@section('title', 'Raw Meterial Sub Category List')
@section('content')
<style>
    td.details-control {
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                {!! Form::button('<i class="fa fa-desktop "></i>&nbsp; Specification <b></b>', [
                ...
                <div class="table-responsive">
                    <table id="group_list" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            @foreach($datas as $key=>$scategory)
                            <tr>
                                <td>{{ ++$key }}</td>
                                <td>{{ $scategory->category_data() ? $scategory->category_data()->first()->category : "" }}</td>
                                <td>{{ $scategory->sub_category }}</td>
                                <td>
                                    <a href="{{route('subcategory',encrypt($scategory->code))}}" data-bs-toggle="tooltip" title="Edit">
