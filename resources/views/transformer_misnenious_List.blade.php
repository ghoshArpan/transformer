...
<div class="content-header">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-6">
            {!! Form::button('<i class="fa fa-desktop "></i>&nbsp; Misclenious <b></b>', [
            ...
            <div class="col-sm-2">
                <a href="javascript:void(0)">
                    <button type="button" class="btn btn-info d-none" id="add_logistics" style="padding:7px"> &nbsp; Add Mislcenious &nbsp;</button>
                </a>
            </div>
            <!-- <div class="col-sm-2">
                <a href="javascript:void(0)">
...
$(document).ready(function() {
    ...
    html: `
        <input id="amount" class="swal2-input" placeholder="Amount" type="number" min="0">
        <input id="remarks" class="swal2-input" placeholder="Purpose" type="text">
    `,
    preConfirm: () => {
